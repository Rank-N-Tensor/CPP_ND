...
vector<int> *RandomNumbers1() // this function returns a pointer of type vector<int>
{
...
int main()
{
    ...
    vector<int> * random_numbers_1;
    random_numbers_1 = RandomNumbers1(); // we now have a pointer to the data stored in the memory block created by the function
