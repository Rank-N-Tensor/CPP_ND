...
template <class T> // templates for class, cool. read https://stackoverflow.com/questions/2023977/difference-of-keywords-typename-and-class-in-templates
//from what i understand, typename and class are largely interchangable
class MyClass
{
    T *data = nullptr;
...
public:
    ...
    // copy constructor
    MyClass(const MyClass &)=delete; //alt make pvt

    // copy assignment operator
    MyClass &operator=(const MyClass &)=delete; //alt make pvt
